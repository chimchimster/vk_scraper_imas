...
@dataclass
class TokenStorage:
    path_to_tokens: pathlib.Path = pathlib.Path.cwd() / 'scarpper' / 'token' / 'schemas' / 'tokens.JSON'


schemas = Schemas(
    pathlib.Path.cwd() / 'api' / 'schemas' / 'user_fields.JSON',
    pathlib.Path.cwd() / 'api' / 'schemas' / 'group_fields.JSON',
    pathlib.Path.cwd() / 'scarpper' / 'token' / 'schemas' / 'tokens.JSON',
    pathlib.Path.cwd() / 'scarpper' / 'token' / 'schemas' / 'rate_limited.JSON'
)
